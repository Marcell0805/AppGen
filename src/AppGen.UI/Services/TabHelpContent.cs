...
public static class TabHelpContent
{
    ...
    public static string GetBodyHtml(string tabId) => tabId switch
    {
        "project" => """
            ...
            <section class="help-section"><h3>What you can configure</h3><ul><li>App name and output folder</li><li>Tagline and description (used in READMEs and Documentation vision)</li><li>Layer toggles: Documentation, Web, Mobile</li><li>Web: enable JWT API authentication</li><li>Mobile: offline SQLite cache and theme preset (appgen, portal, cookbook)</li><li>Entities and properties (shared across all layers)</li></ul></section>
