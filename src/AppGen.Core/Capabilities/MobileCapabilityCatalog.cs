...
public static class MobileCapabilityCatalog
{
    ...
    [
        ...
        Def(MobileCapabilityId.Bluetooth, "Connectivity", "Bluetooth", implemented: true,
            ...
            service: "bluetooth_service.dart.scriban", file: "bluetooth_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.Nfc, "Connectivity", "NFC", implemented: true,
            packages: [Pkg("nfc_manager", "^3.5.0")],
            android: ["NFC"],
            service: "nfc_service.dart.scriban", file: "nfc_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Gps, "Location", "GPS", implemented: true,
            ...
            service: "location_service.dart.scriban", file: "location_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Maps, "Location", "Maps", implemented: true,
            ...
            ios: ["NSLocationWhenInUseUsageDescription"],
            service: "maps_service.dart.scriban", file: "maps_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Geofencing, "Location", "Geofencing", implemented: true,
            ...
            service: "geofencing_service.dart.scriban", file: "geofencing_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Camera, "Media", "Camera", implemented: true,
            ...
            service: "camera_service.dart.scriban", file: "camera_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.Gallery, "Media", "Gallery", implemented: true,
            packages: [Pkg("image_picker", "^1.1.2"), Pkg("permission_handler", "^11.3.1")],
            android: ["READ_MEDIA_IMAGES"],
            ios: ["NSPhotoLibraryUsageDescription"],
            service: "gallery_service.dart.scriban", file: "gallery_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.VideoRecording, "Media", "Video Recording", implemented: true,
            ...
            service: "video_recording_service.dart.scriban", file: "video_recording_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.AudioRecording, "Media", "Audio Recording", implemented: true,
            ...
            service: "audio_recording_service.dart.scriban", file: "audio_recording_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.FilePicker, "Media", "File Picker", implemented: true,
            packages: [Pkg("file_picker", "^8.1.2")],
            service: "file_picker_service.dart.scriban", file: "file_picker_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.ImageCompression, "Media", "Image Compression", implemented: true,
            ...
            service: "image_compression_service.dart.scriban", file: "image_compression_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.ImageCropping, "Media", "Image Cropping", implemented: true,
            packages: [Pkg("image_cropper", "^8.0.2")],
            service: "image_cropping_service.dart.scriban", file: "image_cropping_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Biometrics, "Device", "Biometrics", implemented: true,
            ...
            service: "biometric_service.dart.scriban", file: "biometric_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Notifications, "Device", "Local notifications", implemented: true,
            ...
            ios: [],
            service: "notification_service.dart.scriban", file: "notification_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Contacts, "Device", "Contacts", implemented: true,
            ...
            service: "contacts_service.dart.scriban", file: "contacts_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Calendar, "Device", "Calendar", implemented: true,
            ...
            service: "calendar_service.dart.scriban", file: "calendar_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Vibration, "Device", "Vibration", implemented: true,
            ...
            service: "vibration_service.dart.scriban", file: "vibration_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.Ocr, "Intelligence", "OCR (Text Recognition)", implemented: true,
            ...
            service: "ocr_service.dart.scriban", file: "ocr_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.BarcodeScanner, "Intelligence", "Barcode Scanner", implemented: true,
            packages: [Pkg("mobile_scanner", "^6.0.2")],
            android: ["CAMERA"],
            ios: ["NSCameraUsageDescription"],
            service: "barcode_scanner_service.dart.scriban", file: "barcode_scanner_service.dart", nativeOnly: true),

        Def(MobileCapabilityId.QrScanner, "Intelligence", "QR Scanner", implemented: true,
            packages: [Pkg("mobile_scanner", "^6.0.2")],
            android: ["CAMERA"],
            ios: ["NSCameraUsageDescription"],
            service: "qr_scanner_service.dart.scriban", file: "qr_scanner_service.dart", nativeOnly: true),
        ...
        Def(MobileCapabilityId.FaceDetection, "Intelligence", "Face Detection", implemented: true,
            ...
            android: ["CAMERA"],
            ios: ["NSCameraUsageDescription"],
            service: "face_detection_service.dart.scriban", file: "face_detection_service.dart", nativeOnly: true),
        ...
        bool nativeOnly = false) => new()
    {
        ...
        RequiresNativePlatform = nativeOnly
    };
}
